...
EVAA = [
    [
        InlineKeyboardButton(text="• ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ •", url=f"https://t.me/MUSIC_BOT_FREE_bot?startgroup=true"),
    ],
]
...
@app.on_message(filters.command(["xxinfo", "xxinformation", "xxuserinfo"], prefixes=["/", "!", "%", ",", "", ".", "@", "#"]))
